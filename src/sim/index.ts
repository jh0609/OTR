...
export {
  ...
  createReferenceExpectimaxPolicy,
  createSelectiveLate3PlyPolicy,
  expectimaxPolicyDefault,
  expectimaxPolicyReference,
  ...
  type ExpectimaxFns,
  type ReferenceExpectimaxConfig,
...
export {
  ...
  hybridMinimalPolicyDebugCounters,
  resetHybridMinimalPolicyDebugCounters,
  snapshotHybridMinimalPolicyDebugCounters,
...
export {
  ...
  meanViableMoveCountOnRebuildCandidates,
  meanViableMoveCountAfterAcceptedRebuild,
  meanViableMoveCountAfterRejectedRebuild,
  ...
  isViableMove,
  isDeadPosition,
  type ClosureSearchConfig,
  type ClosureSearchResult,
  type ClosureDecisionReport,
  type ClosureDebugCounters,
